...
public class BaseTest {
    ...
    @BeforeScenario
    public void Education() throws MalformedURLException {  //Testin hangi platformda koşacağı seçilir.
        if (localAndroid) {
            ...
            System.out.println("IOS test is starting.");
            DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
            desiredCapabilities
    ...
    @AfterScenario
    public void afterScenario() {  //Driver kapatılır.
